...
| `adgh.txt`   | 针对 `AdGuardHome` 的规则，包含 `domain.txt` `regex.txt` `hosts.txt`和`mylist.txt` | [✈️点击查看](https://raw.githubusercontent.com/hululu1068/AdGuard-Rule/main/rule/adgh.txt)   | [🚀点击查看](https://cdn.jsdelivr.net/gh/hululu1068/AdGuard-Rule/main/rule/adgh.txt)   |
